    ...
    experiences.forEach((experience, index) => {
        experienceCards.push(`
            <div class="steps-container">
                <div class="content">
                    <h2 id=${'jobName-'+index}>${experience.title['pt']}</h2>
                    <span class="timeline-date" id=${'date-'+index}>${experience.company['pt']} | ${experience.date['pt']}</span>
                    <p id=${'descExperience-'+index}>${experience.description['pt']}</p>
                </div>
                <i class="step-line"></i>
                <div class="date" id=${'yearExperience-'+index}>${experience.year['pt']}</div>
            </div>
        `);
    });
